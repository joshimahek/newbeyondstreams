...
interface CuriousInterestsQuestionProps {
  onNext: () => void;
}
...
export function CuriousInterestsQuestion({ onNext }: CuriousInterestsQuestionProps) {
  ...
  const handleContinue = () => {
    ...
    completeStep('curious-interests-question');
    
    // Proceed to next screen
    onNext();
  };

  const progress = 15; // First question in curious flow
    ...
    <div className="min-h-[calc(100vh-96px)] w-full flex flex-col px-8 py-12">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="max-w-3xl mx-auto w-full space-y-10">
          ...
          >
            Pick what sounds most interesting right now.
          </motion.h2>
