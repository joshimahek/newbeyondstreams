...
interface GrowthDesiresQuestionProps {
  onNext: () => void;
}
...
export function GrowthDesiresQuestion({ onNext }: GrowthDesiresQuestionProps) {
  ...
  const options: OptionType[] = [
    { 
      id: 'autonomy', 
      label: 'More autonomy', 
      signals: { exploratory: 2 }
    },
    { 
      id: 'creative', 
      label: 'More creative input', 
      signals: { creative: 2 }
    },
    { 
      id: 'people', 
      label: 'More people interaction', 
      signals: { social: 2 }
    },
    { 
      id: 'technical', 
    ...
    { 
      id: 'leadership', 
      label: 'More leadership', 
      signals: { structured: 1, social: 1 }
    },
  ];
  ...
  const handleContinue = () => {
    ...
    completeStep('growth-desires-question');
    
    // Proceed to next screen
    onNext();
  };

  const progress = 30; // Second question in growth flow
    ...
    <div className="min-h-[calc(100vh-96px)] w-full flex flex-col px-8 py-12">
      ...
      <div className="flex-1 flex items-center justify-center">
        <div className="max-w-3xl mx-auto w-full space-y-10">
          ...
          >
            What would you like more of in your work?
          </motion.h2>
