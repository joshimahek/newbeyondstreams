...
export function LearningStyleQuestion({ onNext }: LearningStyleQuestionProps) {
  ...
  const options: OptionType[] = [
    { 
      id: 'hands-on', 
      label: 'Trying things hands-on', 
      signals: { exploratory: 2 }
    },
    { 
      id: 'observing', 
      label: 'Watching or observing first', 
      signals: { structured: 1, analytical: 1 }
    },
    { 
      id: 'researching', 
      label: 'Reading or researching deeply', 
  ...
  const handleContinue = () => {
    ...
    completeStep('learning-style-question');
    
    // Proceed to next screen
    onNext();
  };

  const progress = 30; // Second question, showing 30% progress
